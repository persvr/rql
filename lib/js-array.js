...
require.def||(require.def=function(deps, factory){module.exports = factory(require, exports, require("./parser"));});
require.def(["require", "exports", "./parser"], function(require, exports, Parser){
...
exports.query = query;
// TODO: kriszyp: consider enabling
//Array.prototype.match = function(q, options){return query(q, options || {}, this);};
