...
function query(query, options, target){
	...
	function queryToJS(value){
		if(value && typeof value === "object" && !(value instanceof Array)){
			...
			if(jsOperator){
				if (jsOperator === '===' && typeof value.args[1] === 'string' && value.args[1].indexOf('re:') === 0){
				...
				return "(function(){return (operators['" + value.name + "']||relay).call(this" +
