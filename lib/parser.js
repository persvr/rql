 ...
 */
require.def||(require.def=function(deps, factory){module.exports = factory(require, exports, modQuery=require('./query'));});
require.def(["require", "exports", "./query"], function(require, exports, modQuery){

var Query = modQuery.Query;
